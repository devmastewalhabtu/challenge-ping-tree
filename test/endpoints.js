...
test.serial.cb('should create target by POST /api/targets',
  function (t) {
    var url = '/api/targets'
...
test.serial.cb('should get targets by GET /api/targets',
  function (t) {
    var url = '/api/targets'
...
test.serial.cb('should get specified target by GET /api/target/:id',
  function (t) {
...
test.serial.cb('should update target by POST /api/target/:id',
  function (t) {
    var selectedTarget = testTargets[testTargets.length - 1]
    var url = `/api/target/${selectedTarget.id}`
...
test.serial.cb('should route reject decision if given unaccepted hour',
  function (t) {
    var url = '/route'
    var routeRequest = {
      geoState: 'ca',
...
test.serial.cb('should route reject decision if given unaccepted state',
  function (t) {
    var url = '/route'
    var routeRequest = {
...
test.serial.cb(
  'should route reject decision if target max accepts per day exceeds',
  function (t) {
    var url = '/route'
    var routeRequest = {
...
test.serial.cb('should route respond with url for acceptable state and hour',
  function (t) {
    var url = '/route'
    var routeRequest = {
      geoState: 'ca',
...
test.serial.cb('should route respond with url of highest value target',
  function (t) {
    var url = '/route'
    var routeRequest = {
      geoState: 'ca',
